<template>
  <main class="container mx-auto py-10 gap-4 flex flex-col">
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Learn More Academy.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Learn More Academy, accessible from
          <a href="https://learn-more-academy.edu" rel="external nofollow noopener" target="_blank"
            >https://learn-more-academy.edu</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: learnmore.at.academy@gmail.com</li>
    </ul>
  </main>
</template>
